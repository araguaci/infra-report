...
(function () {
  ...
  function render(data) {
    ...
    $("meta").innerHTML = [
      ...
      `tool ${data.tool || "analisar-infra.sh"} v${data.version || "?"}`,
    ...
    $("footer").textContent = `${data.tool || "analisar-infra.sh"} v${data.version || ""} · gerado para visualização local`;
